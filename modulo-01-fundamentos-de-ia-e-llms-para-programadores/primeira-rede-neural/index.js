...
async function trainModel(inputXs, outputYs) {
    ...
    // vai receber a entrada de 7 posições (idade normalizada + 3 cores +  3 localizações)

    // 80 neurônios = aqui eu coloquei tudo isso, pq tem pouca base de treino
    ...
    // Exemplo classico da utilização do categoricalCrossentropy: classificação de imagens, recomendação, categorização de usuários
    ...
    // shuffle: embaralha os dados, para evitar viéses
    await model.fit(
        inputXs,
        outputYs,
        {
            verbose: 0,
            epochs: 100, // informa ao modelo para ele passar pela base de dados 100 vezes
...
async function predict(model, pessoa) {
    // transformar o array JS para o tensorflow js (tfjs)
...
// Exibir o resultadado da predição em probabilidades
